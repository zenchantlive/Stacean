...
/* 
 * STYLES - using CSS variables from design-tokens.css
 * 
 * These styles use rem units throughout for responsive scaling.
 * Touch targets are minimum 44px (2.75rem) per Apple HIG.
 */
