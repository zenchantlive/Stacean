...
import { taskTracker, type CreateTaskInput, type UpdateTaskInput, type Task, type TaskPriority, type TaskStatus } from '@/lib/integrations/beads/tracker';
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (project && project !== 'all') {
      return NextResponse.json(tasks.filter(t => t.id.startsWith(`${project}-`)));
    }
