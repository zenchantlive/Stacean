...
## 11) Open Questions
- Confirm exact Beads status label for "Open" vs "Todo" and "Tombstone" usage
...
## References
- `memory/dual-write-kv-beads-architecture.md`
- Beads Graph Model (parent/child + dependency edges)
